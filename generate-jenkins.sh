...
helm template ${CURRENT_DIR}/jenkins-master -f ${CURRENT_DIR}/jenkins-master/values.yaml -f ${CURRENT_DIR}/jenkins-master/hw_override.yaml --name jenkins > jenkins.yaml
